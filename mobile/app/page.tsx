...
import ChatInterfaceMobile from './components/ChatInterfaceMobile';
import SubscriptionModal from './components/SubscriptionModal';
import SubscriptionStatus from './components/SubscriptionStatus';
import ArtistProfileSetup from './components/ArtistProfileSetup';
import BotTour from './components/BotTour';
...
export default function Home() {
  ...
  const [showBotTour, setShowBotTour] = useState(false);
      ...
      <div className="tab-content">
                    {activeTab === 'chat' && (
                      <div className="chat-tab-content">
                        <ComponentErrorBoundary componentName="SubscriptionStatus">
                          <SubscriptionStatus 
